...
bob = User.new(email: "seed_user_bob@ymail.com", password: "123456", age: 30, gender: "male", first_name: "Bob", overview: "#{Faker::Creature::Dog.meme_phrase}, #{Faker::Creature::Dog.sound}")
betty = User.new(email: "seed_user_betty@ymail.com", password: "654321", age: 20, gender: "female", first_name: "Betty", overview: "#{Faker::Creature::Dog.meme_phrase}, #{Faker::Creature::Dog.sound}")
george = User.new(email: "seed_user_george@ymail.com", password: "123456", age:50, gender: "male", first_name: "George", overview: "#{Faker::Creature::Dog.meme_phrase}, #{Faker::Creature::Dog.sound}")
talina = User.new(email: "seed_user_talina@ymail.com", password: "123456", age: 60, gender: "female", first_name: "Talina", overview: "#{Faker::Creature::Dog.meme_phrase}, #{Faker::Creature::Dog.sound}")
matt = User.new(email: "seed_user_matt@ymail.com", password: "123456", age: 40, gender: "male", first_name: "Matt", overview: "#{Faker::Creature::Dog.meme_phrase}, #{Faker::Creature::Dog.sound}")
...
spot = Dog.new(name: "Spot", age: 2, gender: "male", size: "large", breed: "labrador")
spot.user = bob
...
fuzz.user = betty
egg = Dog.new(name: "Egg", age: 6, gender: "male", size: "tiny", breed: "egg")
egg.user = george
mountain = Dog.new(name: "Ruby", age: 1, gender: "female", size: "horse", breed: "mountain dog")
mountain.user = talina
croissant = Dog.new(name: "Toast", age: 3, gender: "male", size: "large", breed: "husky")
croissant.user = matt
...
puts "Start creating faker users, dogs & matches"
num = 0
20.times do
  num += 1
